...
public class GalleryController implements Serializable {
    ...
    @Value("C:/Users/Karol/IdeaProjects/RestApi3/src/main/resources/static/image/")
    ...
    @ResponseBody
    public StringResponse delete(@PathVariable("index") int index) {
    ...
    @PostMapping("/uplooad")
    @ResponseBody
    public StringResponse singleFileUpload(@RequestParam("file") MultipartFile file) {
