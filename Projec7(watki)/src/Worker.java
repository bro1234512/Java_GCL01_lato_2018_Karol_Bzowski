...
public class Worker {
    ...
    private final ConcurrentLinkedQueue<container> queue = new ConcurrentLinkedQueue<>();
    ...
    void enqueueTask(String taskName, Task task) {
        queue.add(new container(taskName, task));
    }
    ...
    private static class container {
        ...
        private container(String name, Task task) {
            this.name = name;
            this.task = task;
        }
    }
